  ...
  constructor(platform : Platform, statusBar : StatusBar, splashScreen : SplashScreen, private ibeacon : IBeacon) {
    platform
      ...
      .then(() => {
        ...
        // let ID = '7CDD91FB-F386-431A-B187-2F874390048C';
        let ID = '2F234454-CF6D-4A0F-ADF2-F4911BA9FFA6';
        let beaconRegion = this
          .ibeacon
          .BeaconRegion('testBeacon32', ID, 3, 1)
        this
          .ibeacon
          .startMonitoringForRegion(beaconRegion)
          .then(() => console.log('Native layer recieved the request to monitoring'), error => console.error('Native layer failed to begin monitoring: ', error));

        window['delegateTest'] = delegate;
      });
